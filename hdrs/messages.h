...
/*	from OpenSolaris "messages.h	1.35	06/11/17 SMI"	*/

/*
 * Portions Copyright (c) 2007 Gunnar Ritter, Freiburg i. Br., Germany
 *
 * Sccsid @(#)messages.h	1.4 (gritter) 2/25/07
 */
...
#define	ERR_USAGE_PKGASK		gettext("usage: %s -r response [-d device] [pkg [pkg ...]]\n")
...
#else
#define	MSG_CHECKREMOVE_PKG_IN_GZ	gettext("## Verifying package <%s> dependencies")
#endif
...
#else
#define	MSG_INSTALLING_PKG_IN_GZ	gettext("## Installing package <%s>")
#endif
